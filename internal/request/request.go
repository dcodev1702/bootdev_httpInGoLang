...
func (r *Request) parse(data []byte) (int, error) {
	...
	for {
		...
		case StateBody:
			...
			// When we've consumed all provided data but still expect more body
			// bytes, exit the parse loop so the caller can fetch more from the
			// reader instead of spinning forever.
...
func RequestFromReader(reader io.Reader) (*Request, error) {
    ...
    for !request.done() {
        ...
        // Move this check BEFORE EOF handling
